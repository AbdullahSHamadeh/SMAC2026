...
abstract final class FamilyCompassTypography {
  static TextTheme base(TextTheme source) {
    return source.copyWith(
      ...
      bodyLarge: source.bodyLarge?.copyWith(fontSize: 16, height: 1.50),
      bodyMedium: source.bodyMedium?.copyWith(fontSize: 14, height: 1.43),
      bodySmall: source.bodySmall?.copyWith(fontSize: 12, height: 1.33),
