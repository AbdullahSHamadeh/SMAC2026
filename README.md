...
- An Apple Development identity and free Personal Team provisioning profile were created. The signed Firebase-enabled Profile app was installed and launched successfully on the connected physical iPhone after its Developer App profile was trusted. It can open directly from the Home Screen without Flutter tooling.
