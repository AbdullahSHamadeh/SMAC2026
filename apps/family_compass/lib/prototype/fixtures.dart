...
const familyMembers = <FamilyMember>[
  ...
  FamilyMember(
    ...
    name: 'Dad',
    relationship: 'Father',
    relationshipKind: FamilyRelationshipKind.father,
    initials: 'D',
  ),
  FamilyMember(
    id: 'mom',
    name: 'Mom',
    relationship: 'Mother',
    relationshipKind: FamilyRelationshipKind.mother,
    initials: 'M',
  ),
  FamilyMember(
    id: 'sara',
    name: 'Sara',
    relationship: 'Sister',
    relationshipKind: FamilyRelationshipKind.sister,
    initials: 'S',
  ),
];
  ...
  return <String, SharedStatus>{
    if (includeDad)
      'dad': SharedStatus(
        ...
        recipientIds: const {'abdullah', 'mom'},
